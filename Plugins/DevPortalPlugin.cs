...
using DevPortalAIKit.Plugins.Models;
using DevPortalAIKit.Plugins.Utils;

namespace DevPortalAIKit.Plugins
{
    public sealed class DevPortalPlugin
    {
        [KernelFunction, Description("What groups or categories of APIs do we support")]
        public async static Task<List<AppCatalogGroup>> GetAppCatalogGroups()
        {
            ...
            var appCatGroups = await response.Content.ReadFromJsonAsync<List<AppCatalogGroup>>();
